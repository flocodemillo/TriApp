...
/**
 * A list fragment representing a list of FlowCharts. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link FlowChartDescriptionFragment}.
 * <p/>
 * Activities containing this fragment MUST implement the {@link Callbacks}
 * interface.
 */
public class FlowChartIndexFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<FlowChart>(
                getActivity(),
                android.R.layout.simple_list_item_1,
                android.R.id.text1,
                Manchester.getFlowchartList()));
    }
